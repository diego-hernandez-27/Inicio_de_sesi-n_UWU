...
def generate_cifrado_cesar_pdf():
    content = """
    ...
    return generate_pdf(html, "cifrado_cesar.pdf")

def generate_votacion_electronica_pdf():
    content = """
    ...
    return generate_pdf(html, "votacion_electronica.pdf")

def generate_cifrado_pigpen_pdf():
    content = """
        ...
        <ul>
            <li>Protección de documentos y rituales masónicos</li>
            <li>Comunicación secreta entre miembros</li>
            <li>Autenticación de documentos importantes</li>
            <li>Preservación de la privacidad de las ceremonias</li>
        </ul>

        <h3>Legado y Uso Moderno</h3>
        <ul>
            <li>Se utiliza en juegos y rompecabezas</li>
            <li>Es una herramienta educativa para enseñar criptografía básica</li>
            <li>Aparece en libros y películas sobre masones</li>
            <li>Se usa en actividades de team building y escape rooms</li>
        </ul>

        <h3>Vulnerabilidades</h3>
        <ul>
            <li>Fácil de descifrar una vez que se conoce el patrón</li>
            <li>No proporciona seguridad real en la era digital</li>
            <li>Limitado a caracteres alfabéticos</li>
            <li>No incluye autenticación ni integridad</li>
        </ul>
    """
    html = generate_pdf_content("El Cifrado Pigpen", "El lenguaje secreto de los masones", content)
    return generate_pdf(html, "cifrado_pigpen.pdf") 